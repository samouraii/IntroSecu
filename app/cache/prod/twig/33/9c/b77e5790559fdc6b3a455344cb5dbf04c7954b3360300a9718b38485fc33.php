...
class __TwigTemplate_339cb77e5790559fdc6b3a455344cb5dbf04c7954b3360300a9718b38485fc33 extends Twig_Template
{
                ...
                if ((isset($context["display"]) ? $context["display"] : null)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                        ...
                        if ((($this->getAttribute($context["admin"], "hasroute", array(0 => "create"), "method") && $this->getAttribute($context["admin"], "isGranted", array(0 => "CREATE"), "method")) || ($this->getAttribute($context["admin"], "hasroute", array(0 => "list"), "method") && $this->getAttribute($context["admin"], "isGranted", array(0 => "LIST"), "method")))) {
                            // line 48
                            echo "                            ";
                            echo call_user_func_array($this->env->getFunction('sonata_block_render')->getCallable(), array(array("type" => "sonata.admin.block.search_result"), array("query" => (isset($context["query"]) ? $context["query"] : null), "admin_code" => $this->getAttribute($context["admin"], "code", array()), "page" => 0, "per_page" => 10)));
                            // line 55
                            echo "
                        ";
                        }
