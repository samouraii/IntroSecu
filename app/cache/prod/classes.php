...
$tabs = $this->getTabs();
if ($this->currentTab) {
throw new \RuntimeException($tabs[$this->currentTab]["auto_created"] ?"New tab was added automatically when you have added field or group. You should close current tab before adding new one OR add tabs before adding groups and fields":"You should close previous tab with end() before adding new tab");
