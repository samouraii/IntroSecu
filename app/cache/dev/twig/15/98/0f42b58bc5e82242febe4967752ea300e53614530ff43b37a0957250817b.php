...
class __TwigTemplate_15980f42b58bc5e82242febe4967752ea300e53614530ff43b37a0957250817b extends Twig_Template
{
    ...
    ";
        ...
        if ($this->env->getExtension('security')->isGranted("ROLE_ADMIN")) {
            // line 11
            echo "        ";
            echo             $this->env->getExtension('form')->renderer->renderBlock((isset($context["filter_form"]) ? $context["filter_form"] : $this->getContext($context, "filter_form")), 'form');
            echo "
    ";
        }
        // line 13
    ...
    ";
            // line 47
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "getPoint", array()), "html", null, true);
            echo "
    ";
        }
        // line 49
