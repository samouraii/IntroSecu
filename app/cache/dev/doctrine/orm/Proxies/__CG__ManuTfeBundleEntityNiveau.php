 ...
 */
class Niveau extends \Manu\TfeBundle\Entity\Niveau implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Manu\\TfeBundle\\Entity\\Niveau' . "\0" . 'id', '' . "\0" . 'Manu\\TfeBundle\\Entity\\Niveau' . "\0" . 'nom', '' . "\0" . 'Manu\\TfeBundle\\Entity\\Niveau' . "\0" . 'questions');
        }
